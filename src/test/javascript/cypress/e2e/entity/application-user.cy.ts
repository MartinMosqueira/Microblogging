...
describe('ApplicationUser e2e test', () => {
  ...
  describe('new ApplicationUser page', () => {
    ...
    it('should create an instance of ApplicationUser', () => {
      cy.get(`[data-cy="fechaNacimiento"]`).type('2023-12-03');
      cy.get(`[data-cy="fechaNacimiento"]`).blur();
      cy.get(`[data-cy="fechaNacimiento"]`).should('have.value', '2023-12-03');

      cy.get(`[data-cy="telefono"]`).type('1030');
      cy.get(`[data-cy="telefono"]`).should('have.value', '1030');

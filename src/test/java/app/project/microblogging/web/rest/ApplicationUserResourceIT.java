...
class ApplicationUserResourceIT {
    ...
    public static ApplicationUser createEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser().fechaNacimiento(DEFAULT_FECHA_NACIMIENTO).telefono(DEFAULT_TELEFONO);
    ...
    public static ApplicationUser createUpdatedEntity(EntityManager em) {
        ApplicationUser applicationUser = new ApplicationUser().fechaNacimiento(UPDATED_FECHA_NACIMIENTO).telefono(UPDATED_TELEFONO);
        return applicationUser;
    }
    ...
    void createApplicationUser() throws Exception {
        ...
        assertThat(testApplicationUser.getFechaNacimiento()).isEqualTo(DEFAULT_FECHA_NACIMIENTO);
        assertThat(testApplicationUser.getTelefono()).isEqualTo(DEFAULT_TELEFONO);
    }
    ...
    void putExistingApplicationUser() throws Exception {
        ...
        updatedApplicationUser.fechaNacimiento(UPDATED_FECHA_NACIMIENTO).telefono(UPDATED_TELEFONO);
        ...
        ApplicationUser testApplicationUser = applicationUserList.get(applicationUserList.size() - 1);
        assertThat(testApplicationUser.getFechaNacimiento()).isEqualTo(UPDATED_FECHA_NACIMIENTO);
        assertThat(testApplicationUser.getTelefono()).isEqualTo(UPDATED_TELEFONO);
    }
    ...
    void fullUpdateApplicationUserWithPatch() throws Exception {
        ...
        partialUpdatedApplicationUser.fechaNacimiento(UPDATED_FECHA_NACIMIENTO).telefono(UPDATED_TELEFONO);
